# Welcome, test2026, to the 2026 TDI Global Hackathon!
...
| **GitHub**        | [Repo](https://github.com/db-hackathon/test2026)                                                                             | Your team's code repository.                                            |
| **Terraform Cloud** | [Workspace](https://app.terraform.io/app/db-hackathon-2026/workspaces/hack-team-test2026)                                            | Optional Infrastructure as Code for GCP.                                |
| **OpenShift**     | [Console](https://console-openshift-console.apps.dbhackathon.swedencentral.aroapp.io/k8s/cluster/projects/test2026-official) | Optional container platform for deployments.                            |
...
*   **RedHat OpenShift:** Visit the [OpenShift Console](https://console-openshift-console.apps.dbhackathon.swedencentral.aroapp.io/k8s/cluster/projects/test2026-official) and select **AAD** to log in.
...
Infrastructure SA (`infrastructure@hack-team-test2026.iam.gserviceaccount.com` Use this for deploying resources from GitHub Actions or Terraform Cloud. It has the same permissions as a human team member.

Workload SA (`workload@hack-team-test2026.iam.gserviceaccount.com`): Attach this to your compute resources (e.g., Cloud Run, Cloud Functions). It has the following roles:
...
* vars.INFRA_SA_EMAIL - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-test2026.iam.gserviceaccount.com
* vars.INFRA_SA_ID - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-test2026/serviceAccounts/infrastructure@hack-team-test2026.iam.gserviceaccount.com
* vars.OPENSHIFT_NAMESPACE - The OpenShift namespace for your team: test2026-official
...
* vars.PROJECT_ID - Your team's GCP Project ID.: hack-team-test2026
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 317528021846
...
* vars.WORKLOAD_SA_EMAIL - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-test2026.iam.gserviceaccount.com
* vars.WORKLOAD_SA_ID - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-test2026/serviceAccounts/workload@hack-team-test2026.iam.gserviceaccount.com
...
* infra_sa_email - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-test2026.iam.gserviceaccount.com
* infra_sa_id - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-test2026/serviceAccounts/infrastructure@hack-team-test2026.iam.gserviceaccount.com
* openshift_namespace - The OpenShift namespace for your team: test2026-official
...
* project_id - Your team's GCP Project ID.: hack-team-test2026
* project_number - Your teams' GCP Project Number.: 317528021846
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-test2026.iam.gserviceaccount.com
* workload_sa_id - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-test2026/serviceAccounts/workload@hack-team-test2026.iam.gserviceaccount.com

#### OpenShift :rocket:

*   Your team has a project and namespace named `test2026-official`.
