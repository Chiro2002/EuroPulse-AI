...
export default function RootLayout({
  ...
  useEffect(() => {
    ...
    if (currentPage === "forecast" || currentPage === "simulator" || currentPage === "boardroom" || currentPage === "news" || currentPage === "risk") {
      setInsightLoading(false);
      return;
    }
    fetchInsight();
    ...
    >
      ...
      <body className="flex h-screen overflow-hidden bg-page">
        ...
        <AnimatePresence initial={false}>
          {panelOpen && currentPage !== "forecast" && currentPage !== "simulator" && currentPage !== "boardroom" && currentPage !== "news" && currentPage !== "risk" && (
            <motion.div
              key="impact-panel"
